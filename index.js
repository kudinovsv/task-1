// писал-писал и в последний момент понял что числа в общем случае могут быть и отрицательнми.
// но свой срок в две недели я уже исчерпал, поэтому выкладываю как есть.
...
/**
 * функция складывает два неотрицательных числа в строковом представлении. зато работает с числами
